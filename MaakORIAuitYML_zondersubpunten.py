#!/usr/bin/env python3
"""Maak ORI-A XML zonder subagendapunten en verzamel bestanden uit Notubiz-YAML.
...
Voorbeeld:
    ...
    python3 MaakORIAuitYML_zondersubpunten.py \
        --bronmap input \
        --uitvoermap output \
...
def parse_parameters() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "MDTO XML, en verzamel documenten/media."
        )
    )
    parser.add_argument(
        "--bronmap",
